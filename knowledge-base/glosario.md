...
# Glosario canónico Piana

- **Amor 7**: conjunto creativo que Enrique describe como siete películas realizadas durante siete años en siete países; el corpus documenta especialmente las entregas 6/7 y 7/7.
...
- **MODO_INTERNO**: contexto autorizado para consultar material interno o restringido, aplicando minimización de datos.
- **MODO_PUBLICO**: modo predeterminado del agente; excluye datos privados y no concede permiso de publicación automática.
...
- **DOCUMENTADO**: aparece directamente en una fuente primaria del corpus.
- **AUTORREPORTADO**: una persona lo afirma en el corpus, sin corroboración externa aquí.
...
- **AUDIO**: archivo sonoro; sus transcripciones son ayudas y no sustituyen al original.
- **VIDEO**: archivo audiovisual; el análisis distingue texto visible, imagen y habla.

Volver al [índice de la base](README.md). Véanse también [Canon de Piana](piana-canon.md), [Catálogo de medios](media-catalog.md), [Transcripciones](transcripciones.md), [Preguntas abiertas](preguntas-abiertas.md) y [SOUL para Hermes](SOUL.md).
